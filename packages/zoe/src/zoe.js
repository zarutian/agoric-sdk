 ...
 *
 * @callback UpdatePublicAPI
 * Update the publicAPI for the contract instance, as stored by Zoe in
 * the instanceRecord.
 * @param {Object} newPublicAPI - an object whose methods are the API
